<body>
<h2><span class="label label-primary">Edit Donation</span></h2>
...
<tr>
  ...
  <tr>
    ...
    <td><label for="amount"></label>
      ...
      <input type="text" name="amount" id="amount" class="form-control" value="<?php echo $donation['amount']?>" required="" autofocus=""></td>
  </tr>
  <tr>
    <td class="navbar-brand">Account Information</td>
    <td><label for="account_info"></label>
    
      <input type="text" name="account_info" id="account_info" class="form-control" value="<?php echo $donation['account_info']?>" required=""/></td>
  </tr>
  <tr>
  ...
  <input type="hidden" id="donation_id" name="donation_id" value="<?php echo $donation['donation_id'];?>"/>
  <tr>
