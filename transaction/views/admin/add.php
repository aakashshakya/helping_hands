<body>
<h2><span class="label label-primary">Add Transaction</span></h2>
...
<tr>
  ...
  <tr>
    ...
    <td width="225"><label for="transaction_image"></label>
      ...
      <input type="file" name="transaction_image" id="transaction_image" class="form-control" required autofocus></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <input type="button" name="notify" id="notify" value="Submit and Notify"/>
      <a href="<?php echo site_url('admin/transactions')?>">Cancel</a></td>
  </tr>
