...
<table class="table">
  ...
  <tr>
    ...
    <td><label for="event_name"></label>
      ...
      <input type="text" name="start_date" id="start_date" class="form-control" value="<?php echo $event['start_date']?>" required autofocus></td>
  </tr>
  <tr>
    <td class="navbar-brand">End Date</td>
    <td><label for="event_name"></label>
    
      <input type="text" name="end_date" id="end_date" class="form-control" value="<?php echo $event['end_date']?>" required autofocus></td>
  </tr>
  <tr>
